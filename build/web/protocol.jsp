        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Protocol <small>Raw File</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-home"></i> Text
                            </li>
                        </ol>
                    </div>
                </div>
                <%
                        ...
                        java.util.LinkedList<String> protocolRaw = (java.util.LinkedList<String>) request.getSession().getAttribute("protocolR");
                        if(protocolRaw==null){
                    %>
                <div class="row">
                    <article>
                        <h3>File Upload</h3>
                        <form method="POST" enctype="multipart/form-data" action="protocol">
                ...
                <div class="row">
                    ...
                    <%
                            ...
                            for(int i=0;i<protocolRaw.size();i++)
                            {%>
                            <p><%=protocolRaw.get(i)%></p>
                            <%}
                        }
                    %>
                </div>
