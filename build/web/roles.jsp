                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">Role: <%=environment.getProtocol().getRole().get(i).getAgent()%></h3>
                            </div>
                            <div class="panel-body">
                                <div class="col-sm-6">
                                    <ul class="list-group">
                                        <%for(int j=0;j<environment.getProtocol().getRole().get(i).getSteps().size();j++){%>
                                        <li class="list-group-item"><%=environment.getProtocol().getRole().get(i).getSteps().get(j).getDescription()%></li>
                                        <%}%>
                                    </ul>
                                </div>
                            </div>
